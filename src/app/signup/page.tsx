...
export const metadata = {
  title: "Sign up free",
  description:
    "Create your free Humanly account and start humanizing AI content.",
};
      ...
      <div className="container-page relative z-10 flex flex-col items-center text-center gap-5">
        ...
        <BlurFade delay={0.1} duration={0.5} inView>
          <h1 className=" font-black">
            Start writing <AuroraText>human</AuroraText>
          </h1>
        </BlurFade>

        <BlurFade delay={0.2} duration={0.5} inView>
          <p className="text-base sm:text-lg text-muted-foreground text-balance mx-auto">
            Create your free account and humanize your first 500 words today
          </p>
        </BlurFade>
      </div>
