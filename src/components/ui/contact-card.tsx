...
export function ContactCard({
  ...
  return (
    <div
      ...
      {...props}
    >
      <PlusIcon className="absolute -top-3 -left-3 h-6 w-6 text-border" />
      <PlusIcon className="absolute -top-3 -right-3 h-6 w-6 text-border" />
      <PlusIcon className="absolute -bottom-3 -left-3 h-6 w-6 text-border" />
      <PlusIcon className="absolute -right-3 -bottom-3 h-6 w-6 text-border" />
